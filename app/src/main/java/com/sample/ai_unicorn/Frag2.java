...
public class Frag2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tv1 = (TextView) v.findViewById(R.id.frag2_tv1);
        tv2 = (TextView) v.findViewById(R.id.frag2_tv2);

        Bundle bundle3 = getArguments();

        for(int i=0; i<7; i++) {
            String s = bundle3.getString("s"+i);
            Float f = bundle3.getFloat("f"+i);
        ...
        /*String s1 = bundle3.getString("s0");
        String s2 = bundle3.getString("s9");
